...
import com.example.e_commerce_app.activites.CartActivity;
import com.example.e_commerce_app.databinding.ItemCartBinding;
import com.example.e_commerce_app.databinding.QuantityDialogBinding;
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                quantityDialogBinding.pluseBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
